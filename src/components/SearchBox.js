  ...
  return (
    <div className='lg:px-0 px-4'>
      ...
      <div className='flex flex-col gap-7'>
        ...
        <p className='mt-5 text-3xl'> Filter Reviews </p>
        
      <p className=''> POPULAR KEYWORDS </p>


<div className='uppercase flex flex-wrap gap-11'>
  ...
  <p className='keyWord hover:bg-slate-200' onClick={boostClickHnadler}> Boost </p>
        ...
        className='bg-black text-gray-400 p-2 w-7/12' 
        onChange={e => setSearch(e.target.value)} />
      </div>


      <div className='mt-6 mb-20'>{names.filter(val => {
        if (search === "") {
          return val;
        }
        ...
        return (<div key={i.id} className="searchList">
